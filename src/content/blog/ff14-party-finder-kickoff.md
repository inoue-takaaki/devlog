...
description: 個人開発の題材にFF14のパーティー募集アプリを選びました。Nuxt / NestJS / Prisma / Terraform / Fargate という構成をどう選んだか、迷ったところと決め手、それに開発の進め方をまとめた第1回です。
pubDate: 2026-07-02
author: taka
---
...
正直、DB まわりの知識はまだ浅いです。なのでスキーマファーストで分かりやすく、Prisma Studio でデータを目で見ながら進められる Prisma にしました。SQL をゴリゴリ鍛えたいなら Drizzle という選択肢もありますが、まずは入り口のやさしさを取っています。
...
- 構成は Nuxt / NestJS / Prisma / MySQL 8.4 / Terraform / Fargate
