...
まだ enum を2つ置いただけの小さなパッケージですが、**フロントとバックが同じ言葉で話せる土台**ができました。次回はいよいよ、データを保存する場所＝**データベース**を、Docker でローカルに立てます。そしてその先で Drizzle を使い、この shared に置いた enum と実際のテーブルをつなげていく予定です。
